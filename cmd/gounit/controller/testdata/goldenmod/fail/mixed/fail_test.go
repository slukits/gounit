...
func Test2Fail(t *testing.T) { t.Errorf("failing") }

func Test3Pass(t *testing.T) {}

func Test4Failing(t *testing.T) {
...
func (s *Suite_2) Suite_test_2_2(t *T) { t.True(false) }
...
func (s *Suite_4) Suite_test_4_3(t *T) { t.True(false) }
